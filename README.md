...
**Important:** Once you switch policies from FORCE to NO FORCE, some of your lab 3 tests might not pass anymore (depending on your implementation.) This is okay because we are changing to a different set of policies in lab4. You only need to make sure the lab 4 tests pass to get full credit.
